      ...
      <div className="prose-stone mt-10 space-y-8 text-sm leading-relaxed text-stone-600">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            place an order or subscribe to our newsletter. We also
            automatically collect certain data, such as your IP address and
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            support, send order updates, personalize your shopping
            experience, and — with your consent — send marketing
            communications.
          </p>
        </section>
