    ...
    <div className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
      ...
      <div className="text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-stone-500">
          Comfort and Co began with a simple frustration — finding bedding
      ...
      {/* Story image */}
      <div className="mt-12 aspect-[16/7] w-full overflow-hidden rounded-3xl bg-stone-100 shadow-xl shadow-stone-900/5">
        <img
          src="https://placehold.co/1200x525/e3e6df/78716c?text=Our+Workshop"
          alt="Comfort and Co workshop"
      ...
      <div className="mt-14 grid grid-cols-1 gap-10 md:grid-cols-2">
        <div>
          <h2 className="font-serif text-2xl text-stone-900">How it started</h2>
      ...
      {/* Values */}
      <div className="mt-20">
        <h2 className="text-center font-serif text-3xl tracking-tight text-stone-900">
          What we stand for
        </h2>
        <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3">
          {values.map((value) => (
            ...
            >
              <span className="mx-auto flex h-11 w-11 items-center justify-center rounded-full bg-accent-50 font-serif italic text-accent-500">
                {value.title[0]}
              </span>
